...
const contacts = () => {
  ...
  return ( 
      <>
        <ContactForm/>
        <section className="flex items-center bg-white xl:h-screen dark:bg-[#222] font-poppins">
            <div className="max-w-5xl p-4 mx-auto">
                ...
                <div className="max-w-4xl mx-auto mb-12">
                    <div className="flex flex-wrap -mx-4">
                        <div className="w-full px-4 mb-6 md:w-1/3  lg:mb-0">
                            <button className="w-full py-6 bg-red-400 dark:bg-red-400 rounded-xl">
                        ...
                        <div className="w-full px-3 mb-6 md:w-1/3 lg:mb-0 ">
                            <button
                                className="w-full py-6 bg-gray-100 rounded-xl dark:bg-gray-700 dark:hover:bg-gray-900 hover:bg-red-100">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
