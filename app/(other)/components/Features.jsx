const Features = () => {
    return ( 
        <>
            ...
            <svg className="flex-shrink-0 hidden sm:block h-7 w-7 hs-tab-active:text-red-600 text-gray-800 dark:hs-tab-active:text-red-500 dark:text-white" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 5.5A3.5 3.5 0 0 1 8.5 2H12v7H8.5A3.5 3.5 0 0 1 5 5.5z"/><path d="M12 2h3.5a3.5 3.5 0 1 1 0 7H12V2z"/><path d="M12 12.5a3.5 3.5 0 1 1 7 0 3.5 3.5 0 1 1-7 0z"/><path d="M5 19.5A3.5 3.5 0 0 1 8.5 16H12v3.5a3.5 3.5 0 1 1-7 0z"/><path d="M5 12.5A3.5 3.5 0 0 1 8.5 9H12v7H8.5A3.5 3.5 0 0 1 5 12.5z"/></svg>
            <span className="mt-5">
                <span className="hs-tab-active:text-red-600 block font-semibold text-gray-800 dark:hs-tab-active:text-red-500 dark:text-gray-200">All-in-one workspace</span>
            ...
            <span className="mt-5">
                <span className="hs-tab-active:text-red-600 block font-semibold text-gray-800 dark:hs-tab-active:text-red-500 dark:text-gray-200">Automation on a whole new level</span>
            ...
            <span className="mt-5">
                <span className="hs-tab-active:text-red-600 block font-semibold text-gray-800 dark:hs-tab-active:text-red-500 dark:text-gray-200">Solving problems for every team</span>
            ...
            <div className="max-w-[1140px] lg:pb-32 relative">
                ...
                <div className="p-1.5 bg-gray-100 rounded-3xl shadow-[0_2.75rem_5.5rem_-3.5rem_rgb(45_55_75_/_20%),_0_2rem_4rem_-2rem_rgb(45_55_75_/_30%),_inset_0_-0.1875rem_0.3125rem_0_rgb(45_55_75_/_20%)] dark:bg-gray-700 dark:shadow-[0_2.75rem_5.5rem_-3.5rem_rgb(0_0_0_/_20%),_0_2rem_4rem_-2rem_rgb(0_0_0_/_30%),_inset_0_-0.1875rem_0.3125rem_0_rgb(0_0_0_/_20%)]">
                    <img className="max-w-full h-auto rounded-[1.25rem]" src="/team9.jpg" alt="Image Description"/>
                </div>
                </figure>
                {/* End Mobile Device */}
                ...
                <div className="bg-gray-800 rounded-b-lg">
                    <img className="max-w-full h-auto rounded-b-lg" src="/team5.jpg" alt="Image Description"/>
                </div>
                </figure>
                {/* End Browser Device */}
            </div>
            ...
            <div className="max-w-[1140px] lg:pb-32 relative">
                ...
                <div className="p-1.5 bg-gray-700 rounded-3xl shadow-[0_2.75rem_5.5rem_-3.5rem_rgb(0_0_0_/_20%),_0_2rem_4rem_-2rem_rgb(0_0_0_/_30%),_inset_0_-0.1875rem_0.3125rem_0_rgb(0_0_0_/_20%)]">
                    <img className="max-w-full h-auto rounded-[1.25rem]" src="/team7.jpg" alt="Image Description"/>
                </div>
                </figure>
                {/* End Mobile Device */}
                ...
                <div className="bg-gray-800 rounded-b-lg">
                    <img className="max-w-full h-auto rounded-b-lg" src="/bg.jpg" alt="Image Description"/>
                </div>
                </figure>
                {/* End Browser Device */}
            </div>
            ...
            <div className="max-w-[1140px] lg:pb-32 relative">
                ...
                <figure className="hidden absolute bottom-0 start-0 z-[2] max-w-full w-60 h-auto mb-20 ms-20 lg:block">
                <div className="p-1.5 bg-gray-100 rounded-3xl shadow-[0_2.75rem_5.5rem_-3.5rem_rgb(45_55_75_/_20%),_0_2rem_4rem_-2rem_rgb(45_55_75_/_30%),_inset_0_-0.1875rem_0.3125rem_0_rgb(45_55_75_/_20%)] dark:bg-gray-700 dark:shadow-[0_2.75rem_5.5rem_-3.5rem_rgb(0_0_0_/_20%),_0_2rem_4rem_-2rem_rgb(0_0_0_/_30%),_inset_0_-0.1875rem_0.3125rem_0_rgb(0_0_0_/_20%)]">
                    <img className="max-w-full h-auto rounded-[1.25rem]" src="/team1.jpg" alt="Image Description"/>
                </div>
                </figure>
                {/* End Mobile Device */}
                ...
                <div className="bg-gray-800 rounded-b-lg">
                    <img className="max-w-full h-auto rounded-b-lg" src="/team2.jpg" alt="Image Description"/>
                </div>
                </figure>
                {/* End Browser Device */}
            </div>
