  ...
  return (
    ...
    >
      <div className='w-full h-full md:h-[70vh]'>
        ...
        <p className="legend text-center text-white bg-gray-900 bg-opacity-50 p-2">New chapter for silver strikers</p>
      </div>

      <div className='w-full h-full md:h-[70vh]'>
        <Image width={500} height={500} src="/palliative.jpg" alt="Image 2" className="w-full h-full object-cover md:object-top" />
        <p className="legend text-center text-white bg-gray-900 bg-opacity-50 p-2">Palliative care matters</p>
      </div>
      
      <div className='w-full h-full md:h-[70vh]'>
        <Image width={500} height={500} src="/4.png" alt="Image 2" className="w-full h-full object-cover md:object-top" />
        <p className="legend text-center text-white bg-gray-900 bg-opacity-50 p-2">Bullets win agian</p>
      </div>
    </Carousel>
  );
}
